...
$expected = ['data_chegada', 'data_partida', 'quartos', 'adultos','num_cama_ext','nome','apelido','email','num_doc','telefone','endereço','pais_origem','nacionalidade','mot_viagem','info'];
$required = ['data_chegada', 'data_partida', 'quartos', 'adultos','nome','apelido','email','num_doc','telefone','endereço'];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'biggamemaio@gmail.com' =>
            ['#subject#' => 'Reservations - Hotel BigGame',
                '#greeting#' => "You received a reservation request from $nome $apelido. See details below:"],
		$email =>
            ['#subject#' => 'Hotel BigGame Reservation Request',
    ...
    try {
        ...
        $image_ilha = $message->embed(Swift_Image::fromPath('img/maio.png'));
...
center">Reservations - Hotel BigGame</h1>
</td>
</tr>
<tr>

...
$expected = ['nome', 'email', 'No_de_quartos', 'telefone','nacionalidade','conhecimento','motivo_da_estadia','atendimento_na_reserva','atendimento_no_balcão','funcionários','segurança','serviço_check_in','serviço_check_out','serviço_internet','serviço_pequeno-almoçu','comforto_limpeza_de_quartos','envolvente_ao_empreendimento','acessibilidade_ao_empreendimento','acessibilidade_a_ilha','estadia'];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'madalena.barreto@primeconsulting.org' =>
            ['#subject#' => 'Evaluation Hotel BigGame',
...
center">Evaluation - Hotel BigGame</h1>
</td>
</tr>
<tr>
